...
namespace Unity.VRTemplate
{
    ...
    public class RayAttachModifier : MonoBehaviour
    {
        ...
        {
            m_SelectInteractable = GetComponent<UnityEngine.XR.Interaction.Toolkit.IXRSelectInteractable>();
        ...
        {
            if (!(args.interactorObject is UnityEngine.XR.Interaction.Toolkit.XRRayInteractor))
                return;
