...
namespace CinAnnotator
{
...

    {
        ...
        Transform WholeImage, Transform Trash)
        {
            ...
            /*         if (Canvas_script.isReady)
                    {
                        LocatePatch.gameObject.SetActive(true);
                    } */
...

        {
            ...
            /* LocatePatch.GetComponent<Button>().onClick.AddListener(() => WholeImage.GetComponentInChildren<WholeImage>().DisplayPatch()); */

            LocatePatch.gameObject.SetActive(false);
